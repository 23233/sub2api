...
const (
	...
	// SettingKeyOpenAIAdvancedSchedulerCacheMinRate 缓存命中率硬门槛（百分比，默认 80）。
	SettingKeyOpenAIAdvancedSchedulerCacheMinRate = "openai_advanced_scheduler_cache_min_rate"
	// SettingKeyOpenAIAdvancedSchedulerCacheRecoveryMinutes 缓存熔断后的基础冷却时间（分钟，默认 15）。
	SettingKeyOpenAIAdvancedSchedulerCacheRecoveryMinutes   = "openai_advanced_scheduler_cache_recovery_minutes"
