export default {
    settings: {
      ...
      openaiExperimentalScheduler: {
        ...
        cacheMinRateTitle: 'Minimum cache hit rate',
        cacheMinRateDescription: 'Accounts below this threshold are temporarily circuit-breakered until a recovery probe succeeds.',
        cacheRecoveryMinutesTitle: 'Cache circuit recovery time',
        cacheRecoveryMinutesDescription: 'After a cache circuit opens, wait this long before allowing one probe request.',
