export default {
    settings: {
      ...
      openaiExperimentalScheduler: {
        ...
        cacheMinRateTitle: '最低缓存命中率',
        cacheMinRateDescription: '低于阈值的账号会暂时熔断，等待恢复探测。',
        cacheRecoveryMinutesTitle: '缓存熔断恢复时间',
        cacheRecoveryMinutesDescription: '熔断后等待这段时间再允许一次探测请求。',
        weightsTitle: '调度权值覆盖',
